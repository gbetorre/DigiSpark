 ...
 * 
 * Modified by exifarmy (https://github.com/esixarmy/trovare-password-wifi/blob/master/KeyboardES.h)
 * Modified by gbetorre (catch added for question mark, wildcard and angular parenthesis)
 * use DigiKeyboard_IT.h if you write Digispark sketchs to run on computers with italian keyboard layout 
 */
 ...
 public:
  ...
  size_t write(uint8_t chr) {
    if(chr == '@') {
      ...
      sendKeyStroke(45, MOD_SHIFT_RIGHT);
    }
	else if(chr == '\'') {
      sendKeyStroke(45);
    }
      ...
      sendKeyStroke(48, MOD_SHIFT_RIGHT);
    }
	else if(chr == 'ù') {
      sendKeyStroke(49);
    }
